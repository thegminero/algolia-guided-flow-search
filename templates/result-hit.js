...
const resultHit = (hit, bindEvent) => `<a class="result-hit">
  ...
  <div class="result-hit__details">
    <h3 class="result-hit__name">${hit.model}</h3>
  ...
  hit.objectID
}" data-price="${hit.price}" data-name="${hit._highlightResult.model}" data-image="${`${hit.photos.split('|')[0]}`}" data-description="${hit.features}">
  ...
  hit.objectID
}" data-price="${hit.price}" data-name="${hit._highlightResult.model}">
